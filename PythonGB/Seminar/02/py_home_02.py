...
# Ввод данных использования функции

frac1_str: str = str(input('Введите первую дробь с числителем и знаменателем вида “a/b” : '))
frac2_str: str = str(input('Введите вторую дробь с числителем и знаменателем вида “a/b” : '))
